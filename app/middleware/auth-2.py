...
async def get_or_create_user(payload: dict) -> dict:
    ...
    if email_result.data:
        ...
        # Backfill auth0_id if it was missing/different
    ...
    # 3. Insert with conflict handling for the race condition
    try:
        ...
        # Race condition: another request inserted the user between our check and insert
        if "23505" in str(e):
