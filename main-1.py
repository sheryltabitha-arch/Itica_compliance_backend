...
Changes from original:
  ...
  5. Added redirect_slashes=False to fix 307 redirect on /api/v1/extraction/
  6. Removed _ocr_executor shutdown (no longer used after Eden AI migration)
"""
...
app = FastAPI(
    ...
    lifespan=lifespan,
    redirect_slashes=False,  # Fix: prevents 307 redirect on trailing slash URLs
)
